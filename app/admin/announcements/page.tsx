...
export default function AnnouncementsPage() {
  ...
  const handleDelete = async () => {
    try {
      ...
      if (!apiKey || !announcementToDelete) {
        return
      }
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-[#1E1E1E] border-[#2A2A2A] text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">Duyuru bilgilerini güncelleyin.</DialogDescription>
          </DialogHeader>
          <form onSubmit={handleUpdate} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="edit_title" className="text-gray-200">
                Başlık
              </Label>
              <Input
                id="edit_title"
            ...
            <div className="space-y-2">
              <Label htmlFor="edit_content" className="text-gray-200">
                İçerik
              </Label>
              <Textarea
                id="edit_content"
